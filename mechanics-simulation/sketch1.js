...
/*----------------------------Small additions to page---------------------------*/
  ...
  txt7 = createDiv('y');
  txt7.position(330, 200);
  txt8 = createDiv('x');
  txt8.position(370, 270);
...
initGuidance(["hello", "hello2", "helllo2"]);
